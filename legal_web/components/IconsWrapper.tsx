...
export default function LayoutVisibilityWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {!hideSideIcons && (
        <>
          {/* your social icons and WhatsApp button go here */}
          <div className="hidden lg:block fixed left-0 bottom-10 transform -translate-y-1/2 flex flex-col space-y-2 pl-2 z-50">
            <div className="space-y-2">
              ...
              <a
                href="https://www.youtube.com/@jplawsuvidha"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-blue-200 flex items-center justify-center hover:bg-blue-400 transition-colors"
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.135C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.376.506A3.016 3.016 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.135c1.871.506 9.376.506 9.376.506s7.505 0 9.376-.506a3.016 3.016 0 0 0 2.122-2.135C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              {/* Facebook */}
              ...
              <a
                href="https://www.instagram.com/jplawsuvidha?igsh=MTF5OXA1NGdmazRpZw%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-blue-200 flex items-center justify-center hover:bg-blue-400 transition-colors"
              >
          ...
          {/* WhatsApp */}
          <div className="lg:block fixed bottom-52 -right-26 z-50 translate-x-0" >
            {/* <div className='pb-4 h-[100px] w-[400px]'>
